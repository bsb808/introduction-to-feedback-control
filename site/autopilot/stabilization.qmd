...
**Diagram under construction.** Source: `book/w07_lab_usv_pid/chapter/usv_control_architecture.drawio` (edit in [diagrams.net](https://app.diagrams.net)). The SVG below is regenerated from the source.
:::
