...
1. **Stick → setpoint scaling** The controller's input is a target value (also known as a setpoint, comThis specifies how the R/C stic(`CRUISE_SPEED` for throttle, `ACRO_TURN_RATE` for steering).
