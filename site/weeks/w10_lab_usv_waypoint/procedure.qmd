...
![Prototype course run](images/00000035.BIN.coursetime.png){fig-alt="Prototype course run showing the USV's trajectory, waypoints, and acceptance radii." width=60%}

## 7. Deliverable

See the [Lab 3 overview](index.qmd#minimum-viable-deliverable-mvd) for the deliverable details.  