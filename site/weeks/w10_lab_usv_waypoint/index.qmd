...
% CLAUDE: Show me how to reduce this size of this image ![Prototype course run.  The post-processing (scored) course run.](images/00000035.BIN.coursetime.png){fig-alt="Prototype course run showing the USV's trajectory, waypoints, and acceptance radii."}
...
% CLAUDE: Add link to the baseline params file here too.

### For Instructors

% CLAUDE: Add link to course time estimation script
