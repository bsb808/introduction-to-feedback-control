...
\usepackage{amsmath, amsfonts, amsthm, mathpazo}
\usepackage{units}

% highlight macros (soul not available; retained as no-ops if needed)
\newcommand{\hlr}[1]{#1}
\newcommand{\hlg}[1]{#1}
\newcommand{\hlb}[1]{#1}
\newcommand{\hly}[1]{#1}
...
% ── Convenience macros ───────────────────────────────────────
\newcommand{\TF}[2]{\dfrac{#1}{#2}}          % transfer function frac
\newcommand{\plant}[1]{G_{#1}(s)}            % plant TF shorthand
...
\begin{center}
  \huge{\bf ME2801, Lab \#1, \\ USV Modeling and System Identification}
\end{center}
% ============================================================
