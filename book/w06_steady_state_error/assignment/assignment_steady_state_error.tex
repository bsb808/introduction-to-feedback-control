...
For example, $G_p(s)$ might model a DC-motor positioning stage: the
integrator $1/s$ converts angular velocity to angular position, the real
poles  are the motor's electrical and mechanical
time constants, and the zero comes from a tachometer-feedback
element built into the plant. % CLAUDE: Brainstorm applciations that would need accurate velocity control.}
...
plotting the step response. % CLAUDE: Allow students to use analytical and matlab tools as appropriate. 
