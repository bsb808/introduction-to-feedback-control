% gen_figures.m  –  Generate all placeholder figures for pid_article.tex
%
% Run from latex/pid_article/ so that images/ is a reachable relative path.
...
savepdf = @(fig,name) exportgraphics(fig, fullfile('images',[name '.pdf']), 'ContentType','vector');
